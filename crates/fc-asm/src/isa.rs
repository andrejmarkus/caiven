...
pub fn default_specs() -> Vec<OpcodeSpec> {
    ...
    vec![
        ...
        op("INR", OP_INR, &[Register, Register]),
        op("INP", OP_INP, &[Register, Value]),
        op("INPR", OP_INPR, &[Register, Register]),
        op("RNDR", OP_RNDR, &[Register, Register]),
        ...
        op("PALR", OP_PALR, &[Register, Register, Register, Register]),
        op(
            "LINE",
            OP_LINE,
        ...
        op("CIRC", OP_CIRC, &[Register, Register, Register, Register]),
        op("CIRCF", OP_CIRCF, &[Register, Register, Register, Register]),
        op("PSET", OP_PSET, &[Register, Register, Register]),
        op("MGET", OP_MGET, &[Register, Register, Register]),
        op("MSET", OP_MSET, &[Register, Register, Register]),
        op("FGET", OP_FGET, &[Register, Register]),
        op("FSET", OP_FSET, &[Register, Register]),
        op(
            "MAPD",
            OP_MAPD,
            &[Register, Register, Register, Register, Register, Register],
        ),
        op("SPR", OP_SPR, &[Register, Register, Register, Register]),
        op("TNEW", OP_TNEW, &[Register]),
        op("TGET", OP_TGET, &[Register, Register, Register]),
        ...
        op("MUS", OP_MUS, &[Value]),
        op("NOMUS", OP_NOMUS, &[]),
        op("SFXR", OP_SFXR, &[Register]),
        op("MUSR", OP_MUSR, &[Register]),
        op("WAIT", OP_WAIT, &[]),
    ]
}
