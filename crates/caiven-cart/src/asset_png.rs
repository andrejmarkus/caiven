...
//! 16×1 8-bit RGB PNG (pixel `i` = palette color `i`). Map: 192×128 8-bit
...
/// Encodes the map RAM section (row-major, `map[y*MAP_W + x]`, byte = tile id)
/// as a 192×128 grayscale PNG.
